...
export const invoiceExchanges: Record<string, Exchange[]> = {
  ...
  "INV-0891": [
    { timestamp: "11/24/25 10:05 AM", channel: "Email", from: "Recovery Agent", to: "Kellner & Associates", contact: "accounts@kellnerassoc.com", message: "Friendly reminder: Invoice INV-0891 for $18,500 is due on 12/7/25. Please confirm payment method and expected date.", outcome: "Email delivered and opened" },
    { timestamp: "12/3/25 9:20 AM",  channel: "Email", from: "Recovery Agent", to: "Kellner & Associates", contact: "accounts@kellnerassoc.com", message: "Invoice INV-0891 is due in 4 days. Please ensure payment is scheduled. Contact us if you have questions.", outcome: "Opened twice; no reply" },
    { timestamp: "12/11/25 11:30 AM", channel: "Voice", from: "Recovery Agent", to: "Kellner & Associates", contact: "+1 (555) 892-3410", message: "Outbound call to AP contact. Invoice INV-0891 is now 4 days past due. Requested payment status.", outcome: "Reached voicemail; callback message left" },
    { timestamp: "12/17/25 2:45 PM", channel: "Email", from: "Kellner & Associates", to: "Recovery Agent", contact: "collections@clyintel.com", message: "We are disputing this invoice. Several line items do not match the agreed scope of work. We have cc'd our legal team and will respond formally within 10 business days.", outcome: "Dispute filed — legal team cc'd" },
    { timestamp: "12/19/25 10:00 AM", channel: "Email", from: "Recovery Agent", to: "Kellner & Associates", contact: "accounts@kellnerassoc.com", message: "Dispute acknowledged. We have reviewed the line items in question and believe all charges are in scope per the signed agreement dated 9/4/25. Detailed breakdown attached.", outcome: "Dispute response sent; awaiting reply" },
    { timestamp: "12/29/25 3:10 PM", channel: "Text",  from: "Recovery Agent", to: "Kellner & Associates", contact: "+1 (555) 892-3410", message: "Hi — this is a follow-up re: Invoice INV-0891 ($18,500). No response to our dispute reply. Please call us at your earliest convenience to resolve.", outcome: "Delivered; no response" },
    { timestamp: "1/6/26 9:45 AM",   channel: "Voice", from: "Recovery Agent", to: "Kellner & Associates", contact: "+1 (555) 892-3410", message: "Second outbound call. INV-0891 now 30 days past due. Dispute response has not been acknowledged. Advised client that account may be escalated.", outcome: "Reached partner. Committed to internal review by 1/12/26" },
    { timestamp: "1/9/26 4:15 PM",   channel: "Email", from: "Recovery Agent", to: "Kellner & Associates", contact: "accounts@kellnerassoc.com", message: "Final notice prior to escalation: INV-0891 ($18,500) remains unpaid 33 days past due. Dispute response was delivered 12/19. No substantive reply received. Recovery negotiation or formal escalation will proceed by 1/16/26.", outcome: "Email delivered; opened once" },
  ],
  "INV-0904": [
    { timestamp: "12/10/25 9:30 AM", channel: "Email", from: "Recovery Agent", to: "Apex Dynamics", contact: "ar@apexdynamics.com", message: "Friendly reminder: Invoice INV-0904 for $3,300 is due on 12/21/25. Please confirm that payment is scheduled.", outcome: "Email delivered and opened" },
    { timestamp: "12/18/25 11:15 AM", channel: "Email", from: "Recovery Agent", to: "Apex Dynamics", contact: "ar@apexdynamics.com", message: "Invoice INV-0904 is due in 3 days. Please ensure payment is ready. Accepted methods: ACH, wire, or check.", outcome: "Opened; no reply" },
    { timestamp: "12/26/25 2:00 PM", channel: "Email", from: "Recovery Agent", to: "Apex Dynamics", contact: "ar@apexdynamics.com", message: "INV-0904 is now 5 days past due. Please arrange payment immediately or contact us to discuss your situation.", outcome: "Opened twice; no response" },
    { timestamp: "1/5/26 10:30 AM",  channel: "Voice", from: "Recovery Agent", to: "Apex Dynamics", contact: "+1 (555) 047-8821", message: "Outbound call to AP manager. Discussed overdue status of INV-0904. Client cited delayed client payments on their end.", outcome: "Promise to pay by 1/12/26 via ACH — confirmed verbally" },
    { timestamp: "1/14/26 9:00 AM",  channel: "Email", from: "Recovery Agent", to: "Apex Dynamics", contact: "ar@apexdynamics.com", message: "Payment of $3,300 was expected on 1/12/26 and has not been received. Please confirm status or provide revised date.", outcome: "No response. First promise-to-pay broken." },
    { timestamp: "1/22/26 3:45 PM",  channel: "Voice", from: "Recovery Agent", to: "Apex Dynamics", contact: "+1 (555) 047-8821", message: "Second outbound call. Spoke with CFO directly. Client confirmed cash flow pressure and requested 2-week extension.", outcome: "Second promise to pay by 2/5/26 — verbal commitment from CFO" },
    { timestamp: "2/3/26 11:20 AM",  channel: "Voice", from: "Recovery Agent", to: "Apex Dynamics", contact: "+1 (555) 047-8821", message: "Follow-up call ahead of 2/5 deadline. CFO unavailable; left message with AP coordinator. Noted that account will be escalated if no payment received by 2/5.", outcome: "Second promise-to-pay appears at risk. Escalation recommended." },
  ],
};
