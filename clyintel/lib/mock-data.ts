...
export const invoiceExchanges: Record<string, Exchange[]> = {
  "INV-1042": [
    { timestamp: "3/8/26 11:15 AM", channel: "Voice", from: "Clyintel", to: "Vance Studio", contact: "+1 (555) 234-5678", message: "Attempted call to main AP line", outcome: "Voicemail left with callback request" },
    { timestamp: "3/12/26 4:32 PM", channel: "Email", from: "Clyintel", to: "Vance Studio", contact: "ap@vancestudio.com", message: "Initial payment reminder: Invoice #1042 for $12,400 is due on 3/17/26", outcome: "Email delivered and opened once" },
    { timestamp: "3/15/26 9:11 AM", channel: "Email", from: "Clyintel", to: "Vance Studio", contact: "ap@vancestudio.com", message: "Follow-up: Invoice #1042 — Payment due in 3 days", outcome: "Opened. No reply." },
    { timestamp: "3/18/26 3:45 PM", channel: "Email", from: "Clyintel", to: "Vance Studio", contact: "ap@vancestudio.com", message: "Updated invoice PDF resent with corrected PO reference", outcome: "Message delivered successfully" },
    { timestamp: "3/19/26 10:22 AM", channel: "Email", from: "Vance Studio", to: "Clyintel", contact: "team@phoresight.io", message: "Still waiting for CFO approval. PO reference looks correct now. Can we have until end of month?", outcome: "Client requested extension" },
    { timestamp: "3/19/26 2:15 PM", channel: "Email", from: "Clyintel", to: "Vance Studio", contact: "ap@vancestudio.com", message: "Extension granted to 3/31/26. Please confirm payment method (ACH/wire/check).", outcome: "Extension granted; awaiting payment method confirmation" },
    { timestamp: "3/20/26 10:22 AM", channel: "Email", from: "Clyintel", to: "Vance Studio", contact: "ap@vancestudio.com", message: "Reminder: Invoice #1042 past due status", outcome: "Email opened twice; no response" },
    { timestamp: "3/22/26 2:14 PM", channel: "Voice", from: "Clyintel", to: "Vance Studio", contact: "+1 (555) 234-5678", message: "Outbound call to AP desk; reached Sarah Chen", outcome: "Customer committed to payment by 3/31/26 via ACH" },
  ],
  "INV-1038": [
    { timestamp: "3/20/26 9:30 AM", channel: "Email", from: "Clyintel", to: "Meridian Group", contact: "billing@meridiangroup.com", message: "Initial payment reminder: Invoice #1038 for $8,750 is due on 3/25/26", outcome: "Email delivered and opened" },
    { timestamp: "3/23/26 11:45 AM", channel: "Email", from: "Meridian Group", to: "Clyintel", contact: "team@phoresight.io", message: "We need the original invoice resent — our AP system shows no record.", outcome: "Client requested invoice resubmission" },
    { timestamp: "3/26/26 10:22 AM", channel: "Email", from: "Clyintel", to: "Meridian Group", contact: "billing@meridiangroup.com", message: "Past due notice: Invoice #1038 is now overdue", outcome: "Email opened; no response" },
    { timestamp: "3/28/26 2:15 PM", channel: "Text", from: "Clyintel", to: "Meridian Group", contact: "+1 (555) 987-6543", message: "Payment reminder via SMS: Invoice #1038 ($8,750) requires attention", outcome: "Delivered; no response" },
  ],
  "INV-1045": [
    { timestamp: "3/15/26 11:00 AM", channel: "Email", from: "Clyintel", to: "Drift Collective", contact: "accounts@driftcollective.com", message: "Initial payment reminder: Invoice #1045 for $2,800 is due on 3/30/26", outcome: "Email delivered" },
    { timestamp: "3/18/26 2:30 PM", channel: "Email", from: "Drift Collective", to: "Clyintel", contact: "team@phoresight.io", message: "Cash flow issues this month. Can we split into two $1,400 payments over 2 weeks?", outcome: "Client requested payment plan" },
    { timestamp: "3/20/26 3:45 PM", channel: "Voice", from: "Clyintel", to: "Drift Collective", contact: "+1 (555) 456-7890", message: "Outbound call to confirm payment plan details", outcome: "Payment plan confirmed verbally; first payment expected 3/25" },
  ],
  "INV-1046": [
    { timestamp: "3/22/26 9:00 AM", channel: "Email", from: "Clyintel", to: "Drift Collective", contact: "accounts@driftcollective.com", message: "Payment reminder: Invoice #1046 for $2,800 is due on 4/5/26", outcome: "Email delivered and opened" },
  ],
  "INV-1051": [], "INV-1052": [], "INV-1053": [],
  "INV-0891": [
    { timestamp: "11/24/25 10:05 AM", channel: "Email", from: "Clyintel", to: "Kellner & Associates", contact: "accounts@kellnerassoc.com", message: "Friendly reminder: Invoice INV-0891 for $18,500 is due on 12/7/25. Please confirm payment method and expected date.", outcome: "Email delivered and opened" },
    { timestamp: "12/3/25 9:20 AM",  channel: "Email", from: "Clyintel", to: "Kellner & Associates", contact: "accounts@kellnerassoc.com", message: "Invoice INV-0891 is due in 4 days. Please ensure payment is scheduled. Contact us if you have questions.", outcome: "Opened twice; no reply" },
    { timestamp: "12/11/25 11:30 AM", channel: "Voice", from: "Clyintel", to: "Kellner & Associates", contact: "+1 (555) 892-3410", message: "Outbound call to AP contact. Invoice INV-0891 is now 4 days past due. Requested payment status.", outcome: "Reached voicemail; callback message left" },
    { timestamp: "12/17/25 2:45 PM", channel: "Email", from: "Kellner & Associates", to: "Clyintel", contact: "team@phoresight.io", message: "We are disputing this invoice. Several line items do not match the agreed scope of work. We have cc'd our legal team and will respond formally within 10 business days.", outcome: "Dispute filed — legal team cc'd" },
    { timestamp: "12/19/25 10:00 AM", channel: "Email", from: "Clyintel", to: "Kellner & Associates", contact: "accounts@kellnerassoc.com", message: "Dispute acknowledged. We have reviewed the line items in question and believe all charges are in scope per the signed agreement dated 9/4/25. Detailed breakdown attached.", outcome: "Dispute response sent; awaiting reply" },
    { timestamp: "12/29/25 3:10 PM", channel: "Text",  from: "Clyintel", to: "Kellner & Associates", contact: "+1 (555) 892-3410", message: "Hi — this is a follow-up re: Invoice INV-0891 ($18,500). No response to our dispute reply. Please call us at your earliest convenience to resolve.", outcome: "Delivered; no response" },
    { timestamp: "1/6/26 9:45 AM",   channel: "Voice", from: "Clyintel", to: "Kellner & Associates", contact: "+1 (555) 892-3410", message: "Second outbound call. INV-0891 now 30 days past due. Dispute response has not been acknowledged. Advised client that account may be escalated.", outcome: "Reached partner. Committed to internal review by 1/12/26" },
    { timestamp: "1/9/26 4:15 PM",   channel: "Email", from: "Clyintel", to: "Kellner & Associates", contact: "accounts@kellnerassoc.com", message: "Final notice prior to escalation: INV-0891 ($18,500) remains unpaid 33 days past due. Dispute response was delivered 12/19. No substantive reply received. Recovery negotiation or formal escalation will proceed by 1/16/26.", outcome: "Email delivered; opened once" },
  ],
  "INV-0904": [
    { timestamp: "12/10/25 9:30 AM", channel: "Email", from: "Clyintel", to: "Apex Dynamics", contact: "ar@apexdynamics.com", message: "Friendly reminder: Invoice INV-0904 for $3,300 is due on 12/21/25. Please confirm that payment is scheduled.", outcome: "Email delivered and opened" },
    { timestamp: "12/18/25 11:15 AM", channel: "Email", from: "Clyintel", to: "Apex Dynamics", contact: "ar@apexdynamics.com", message: "Invoice INV-0904 is due in 3 days. Please ensure payment is ready. Accepted methods: ACH, wire, or check.", outcome: "Opened; no reply" },
    { timestamp: "12/26/25 2:00 PM", channel: "Email", from: "Clyintel", to: "Apex Dynamics", contact: "ar@apexdynamics.com", message: "INV-0904 is now 5 days past due. Please arrange payment immediately or contact us to discuss your situation.", outcome: "Opened twice; no response" },
    { timestamp: "1/5/26 10:30 AM",  channel: "Voice", from: "Clyintel", to: "Apex Dynamics", contact: "+1 (555) 047-8821", message: "Outbound call to AP manager. Discussed overdue status of INV-0904. Client cited delayed client payments on their end.", outcome: "Promise to pay by 1/12/26 via ACH — confirmed verbally" },
    { timestamp: "1/14/26 9:00 AM",  channel: "Email", from: "Clyintel", to: "Apex Dynamics", contact: "ar@apexdynamics.com", message: "Payment of $3,300 was expected on 1/12/26 and has not been received. Please confirm status or provide revised date.", outcome: "No response. First promise-to-pay broken." },
    { timestamp: "1/22/26 3:45 PM",  channel: "Voice", from: "Clyintel", to: "Apex Dynamics", contact: "+1 (555) 047-8821", message: "Second outbound call. Spoke with CFO directly. Client confirmed cash flow pressure and requested 2-week extension.", outcome: "Second promise to pay by 2/5/26 — verbal commitment from CFO" },
    { timestamp: "2/3/26 11:20 AM",  channel: "Voice", from: "Clyintel", to: "Apex Dynamics", contact: "+1 (555) 047-8821", message: "Follow-up call ahead of 2/5 deadline. CFO unavailable; left message with AP coordinator. Noted that account will be escalated if no payment received by 2/5.", outcome: "Second promise-to-pay appears at risk. Escalation recommended." },
  ],
};
